    ...
    <div className="container my-5 d-flex justify-content-center">
      <div className="card shadow-lg border-0 rounded-4 p-5 col-12 col-md-10 col-lg-8">
        <div className="mb-4 text-center">
          <h1 className="text-secondary fw-bold">{employees.first_name} {employees.last_name}</h1>
        </div>
      ...
      {companies.map((comp, index) => (
        <div className="col-md-6 mb-3" key={index}>
          <div className="border rounded p-3 shadow-sm">
            ...
            <p className="mb-1"><strong>Category:</strong> {comp.categories}</p>
             <p className="mb-1"><strong>Website Link:</strong> {comp.website_link}</p>
              <p className="mb-1"><strong>Contact:</strong> {comp.Contact}</p>
               <p className="mb-1"><strong>Email:</strong> {comp.email}</p>
            <p className="mb-1"><strong>Location:</strong> {comp.province}, {comp.city}</p>
