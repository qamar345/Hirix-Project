...
const JobPost = ({ job, fromShare }) => {
    ...
    const fetchWishlist = async () => {
      try {
        ...
        const res = await axios.get(
          `https://testserver.hirix.pk/getWishlists/${userId}`,
          {
            headers: {
    ...
    if (!check) {
      ...
      try {
        ...
        const res = await axios.post(
          `https://testserver.hirix.pk/apply-for-job/${userid}`,
          null,
          {
            params: { job_id: id },
            headers: {
  ...
  return (
    <div id="1" className="jobDetailWrapper">
      <div className="block-jobs-warrper">
        <div className="block-archive-top">
          ...
          <div className="preview-tabs">
            ...
            >
              <div className="block-archive-inner jobs-insights-details active">
                ...
                <div className="toggle-insights">
                  <a href="#" className="show-more-insights">
                    Show more
                    <i className="fas fa-angle-down" />
                  </a>
                  <a href="#" className="hide-all-insights">
                    Hide less
                    <i className="fas fa-angle-up" />
                  </a>
                </div>
              </div>
              <div className="block-archive-inner jobs-description-details civi-description-details">
                <h4 className="title-jobs">Description</h4>
                <div className="civi-description">
                  ...
                  {/* <ul>
                    <li>
                      ...
                      code design and coding role!
                    </li>

                    <li>
                      Be a valued member of an autonomous, cross-functional team
                      delivering our messaging experience to businesses around
                      the world
                    </li>
                    ...
                    <li>
                      Close-knitted collaboration with equally passionate team
                      members having fun at work and feeling proud that you are
                      a key part of creating world-class solutions for customer
                      engagement
                    </li>
                  </ul>

                  <h4 className="wp-block-heading">Skill &amp; Experience</h4>
                ...
                <div className="toggle-description">
                  ...
                  <a href="#" className="hide-all-description">
                    Hide less
                    <i className="fas fa-angle-up" />
                  </a>
                </div>
            ...
            >
              <div className="company-overview">
                {companyDetail ? (
                  ...
                  <p>
                    Foundation helps creators mint and auction their digital
                    artworks as NFTs on the Ethereum blockchain. As collectors
                    bid, they fuel a new system of value for online
                    expression.&nbsp;
                  </p>

                  <p>
                    NFTs—are empowering artists, musicians, and all kinds of
                    genre-defying digital creators to invent a new cultural
                    paradigm. How this emerging culture of digital art ownership
                    looks is up to all of us.
                  </p>

                  <p>
                    Foundation bridges crypto and culture to create mutual
                    support between artists and collectors. We’re forging a
                    community-driven path, providing culturally pioneering
                    curation, and sharing our tools with the rapidly evolving
                    community of developers who are excited to define this
                    future with us. We want anyone and everyone who cares about
                ...
                <ul className="list-jobs">
                  <li className="list-items">
                    <h6 className="title-link">
                      <a href="#">Chief Product Officer</a>
                    </h6>
                  ...
                  <li className="list-items">
                    <h6 className="title-link">
                      <a href="#">Disability Support Worker / Mentor</a>
                    </h6>
                    <div className="info-company">
                      <div className="categories-warpper">
                        <div className="cate-warpper">
                  ...
                  <li className="list-items">
                    <h6 className="title-link">
                      <a href="#">Content Marketing Manager</a>
                    </h6>
                    <div className="info-company">
                      <div className="categories-warpper">
                        <div className="cate-warpper">
                  ...
                  <li className="list-items">
                    <h6 className="title-link">
                      <a href="#">Product Engineer (Back-end)</a>
                    </h6>
                    <div className="info-company">
                      <div className="categories-warpper">
                        <div className="cate-warpper">
        ...
        {/* Apply Now */}
        <div className="block-archive-inner jobs-apply-details">
